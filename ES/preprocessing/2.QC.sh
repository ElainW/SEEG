...
INPUT_DIR=/n/groups/walsh/indData/elain/DeepWES4_7/final
INTERVAL=/n/groups/walsh/indData/elain/DeepWES4_7/S33266340_hs_hg19/S33266340_Regions.nochr.bed
#BARCODE_LIST=("0863_Ti-G" "0859_Ti-A" "0859_A_" "0863_K" "0873_H" "0864_F" "0861_N_" "0868_R" "0871_J" "0500_B_")
BARCODE_LIST=("0873_H")
for BARCODE_ID in ${BARCODE_LIST[@]}; do
	sbatch -J $BARCODE_ID -N 1 -c 1 --mem=3G -t 0-3:00 -p short -o logs/${BARCODE_ID}_coverage.log --mail-user=yilanwang@g.harvard.edu --mail-type=FAIL,END calc_avg_cov.sh $INPUT_DIR $BARCODE_ID $INTERVAL
done
