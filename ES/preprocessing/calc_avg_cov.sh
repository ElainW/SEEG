...
python3 calc_avg_cov.py -i $INPUT_DIR/${BARCODE_ID}.counts -o $INPUT_DIR/${BARCODE_ID}.coverage
...
python3 calc_avg_cov.py -i $INPUT_DIR/${BARCODE_ID}.final.counts -o $INPUT_DIR/${BARCODE_ID}_final.coverage